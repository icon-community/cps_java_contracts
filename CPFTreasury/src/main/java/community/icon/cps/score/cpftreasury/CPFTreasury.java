...
public class CPFTreasury extends Validations {
    ...
    private boolean proposalExists(String _ipfs_key) {
        return proposalBudgets.get(_ipfs_key) != null;
    }
    ...
    public Map<String, BigInteger> get_total_funds() {
        return Map.of(ICX, Context.getBalance(Context.getAddress()), bnUSD, getTotalFundBNUSD());
    }
    ...
    public Map<String, BigInteger> get_remaining_swap_amount() {
        ...
        return Map.of("maxCap", maxCap, "remainingToSwap", maxCap.subtract(getTotalFundBNUSD()));
    }
    ...
    public void transfer_proposal_fund_to_cps_treasury(String _ipfs_key, int _total_installment_count, Address _sponsor_address, Address _contributor_address, String token_flag, BigInteger _total_budget) {
        ...
        BigInteger bnUSDBalance = Context.call(BigInteger.class, balancedDollar.get(), "bnUSDBalance", Context.getAddress());
        ...
        Context.call(balancedDollar.get(), "transfer", cpsTreasuryScore.get(), totalTransfer, depositProposal.toString().getBytes());
        ProposalFundTransferred(_ipfs_key, "Successfully transferred " + totalTransfer + " " + token_flag + " to CPS Treasury " + cpsTreasuryScore.get());
    }

    @External
    public void update_proposal_fund(String _ipfs_key, @Optional String _flag, @Optional BigInteger _added_budget, @Optional BigInteger _total_installment_count) {
        validateCpsScore();
        ...
        params.add("_added_sponsor_reward", String.valueOf(sponsorReward));
    ...
    public void tokenFallback(Address _from, BigInteger _value, byte[] _data) {
        ...
        if (caller.equals(sICX)) {
            ...
            if (_data != null && _data.length > 0) {
                ...
                Context.revert(TAG + ": Empty data is not accepted.");
            }
        }
    }
